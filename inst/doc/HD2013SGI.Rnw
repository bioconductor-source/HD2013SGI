...
\newcommand{\thetitle}{Mapping genetic interactions in human cancer cells} % used by whbiocvignette.sty

%\pagestyle{empty}
\title{\textsf{\textbf{Mapping genetic interactions in human cancer cells with RNAi and multiparametric phenotyping}\\
