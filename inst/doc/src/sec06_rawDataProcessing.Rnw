...
\begin{equation}
  D_{\cdots\,-\,\cdots\,-\,f\,\cdots} ~ D_{\cdots\,-\,\cdots\,-\,F(i-1)\,\cdots}
\end{equation}
Let $r_{\cdots\,\cdots\,f\,\cdots}$ be the residuals of this fit. The
...
Pearson correlation coefficient $\bar{\rho}_f$  of the residual
vectors $r_{\cdots\,\cdots\,f\,1}$ and $r_{\cdots\,\cdots\,f\,2}$
...
correlation coefficient $\bar{\rho}_f$ is selected.
<<featureSelection3>>=
...
correlation coefficients ($\sum_f(\sign(\bar{\rho}_f)>0) <
\sum_f(\sign(\bar{\rho}_f)<0)$). This criterion is motivated by the
