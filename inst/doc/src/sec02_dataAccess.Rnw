...
?Interactions
@
to see a documentation of the interaction data. The same works for any
of the below data objects. 
...
\begin{itemize}
  ...
  \item {\bf datamatrixfull} The phenotype data of all pairwise genetic perturbation experiments before quality control and feature selection
  ...
  \item {\bf datamatrix} The phenotype data of all pairwise genetic perturbation experiments after quality control and feature selection
  ...
  \item {\bf Interactions} The genetic interaction data (pi-scores, p-values, and annotation)
\end{itemize}
